...
```typescript
import { ReservationWaitlistedEventRequestBody } from "@pushpress/pushpress/models/webhooks";

let value: ReservationWaitlistedEventRequestBody = {
  data: {
    id: "reg_12345",
...
| `event`                                                                                                                                                             | [webhooks.ReservationWaitlistedEventEvent](../../models/webhooks/reservationwaitlistedeventevent.md)                                                                | :heavy_check_mark:                                                                                                                                                  | N/A                                                                                                                                                                 |                                                                                                                                                                     |