...
export async function reservationWaitlistedEvent(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      webhooks.ReservationWaitlistedEventRequestBody$outboundSchema.parse(
        value,
      ),
  ...
  const context = {
    operationID: "reservationWaitlistedEvent",
    oAuth2Scopes: [],
