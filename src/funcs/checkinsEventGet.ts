 ...
 */
export function checkinsEventGet(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetEventCheckinRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/checkins/event/{uuid}")(pathParams);
