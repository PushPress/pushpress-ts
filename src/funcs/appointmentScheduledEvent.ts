...
export async function appointmentScheduledEvent(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      webhooks.AppointmentScheduledEventRequestBody$outboundSchema.parse(value),
  ...
  const context = {
    operationID: "appointmentScheduledEvent",
    oAuth2Scopes: [],
