...
export function reservationsList(
  ...
  PageIterator<
    Result<
      operations.ListReservationsResponse,
      | PushPressError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListReservationsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/reservations")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListReservationsResponse$inboundSchema, {
      key: "Result",
    }),
    M.fail([401, 404, "4XX"]),
    M.fail("5XX"),
