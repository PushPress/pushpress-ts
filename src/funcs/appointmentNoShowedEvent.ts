...
export async function appointmentNoShowedEvent(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      webhooks.AppointmentNoShowedEventRequestBody$outboundSchema.parse(value),
  ...
  const context = {
    operationID: "appointmentNoShowedEvent",
    oAuth2Scopes: [],
