 ...
 * list event checkins
 */
export function checkinsClassList(
  ...
  PageIterator<
    Result<
      operations.ListClassCheckinsResponse,
      | PushPressError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListClassCheckinsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/checkins/class")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListClassCheckinsResponse$inboundSchema, {
      key: "Result",
    }),
    M.fail([401, 404, "4XX"]),
    M.fail("5XX"),
