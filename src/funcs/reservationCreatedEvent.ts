...
export async function reservationCreatedEvent(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      webhooks.ReservationCreatedEventRequestBody$outboundSchema.parse(value),
  ...
  const context = {
    operationID: "reservationCreatedEvent",
    oAuth2Scopes: [],
