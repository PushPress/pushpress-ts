...
export async function customerDetailsChangedEvent(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      webhooks.CustomerDetailsChangedEventRequestBody$outboundSchema.parse(
        value,
      ),
  ...
  const context = {
    operationID: "customerDetailsChangedEvent",
    oAuth2Scopes: [],
