...
export function classesList(
  ...
  PageIterator<
    Result<
      operations.ListClassesResponse,
      | PushPressError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListClassesRequest$outboundSchema.parse(value),
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListClassesResponse$inboundSchema, {
      key: "Result",
    }),
    M.fail([404, "4XX"]),
    M.fail("5XX"),
