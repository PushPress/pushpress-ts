...
export function enrollmentList(
  ...
  PageIterator<
    Result<
      operations.ListEnrollmentsResponse,
      | PushPressError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListEnrollmentsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/enrollments")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListEnrollmentsResponse$inboundSchema, {
      key: "Result",
    }),
    M.fail([401, 404, "4XX"]),
    M.fail("5XX"),
