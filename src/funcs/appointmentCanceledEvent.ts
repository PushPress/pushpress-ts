...
export async function appointmentCanceledEvent(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      webhooks.AppointmentCanceledEventRequestBody$outboundSchema.parse(value),
  ...
  const context = {
    operationID: "appointmentCanceledEvent",
    oAuth2Scopes: [],
