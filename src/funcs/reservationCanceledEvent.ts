...
export async function reservationCanceledEvent(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      webhooks.ReservationCanceledEventRequestBody$outboundSchema.parse(value),
  ...
  const context = {
    operationID: "reservationCanceledEvent",
    oAuth2Scopes: [],
